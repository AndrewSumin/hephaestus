...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="doc" mode="foot">
    ...
    <xsl:comment>noidex</xsl:comment>
  ...
  <xsl:template match="doc[contains(key('protocol', 'host'), 'sales')]" mode="counters">
    ...
    <div style="display:none;">
      <script type="text/javascript">
        try { var yaCounter1197067 = new Ya.Metrika(1197067); } catch(e){}
      </script>
    </div>
    <noscript>
      <div style="position:absolute">
        <img src="//mc.yandex.ru/watch/1197067" alt=""/>
      </div>
    </noscript>
    <!-- /Yandex.Metrika -->
  ...
  <xsl:template match="doc[contains(key('protocol', 'host'), 'med')]" mode="counters">
    ...
    <div style="display:none;">
      <script type="text/javascript">
        try { var yaCounter1202757 = new Ya.Metrika(1202757); } catch(e){}
      </script>
    </div>
    <noscript>
      <div style="position:absolute">
        <img src="//mc.yandex.ru/watch/1202757" alt=""/>
      </div>
    </noscript>
    <!-- /Yandex.Metrika -->
    <div class="margin">
  ...
  <xsl:template match="doc[contains(key('protocol', 'host'), 'stroi')]" mode="counters">
    <div class="margin">
      <div class="layout__padding">
        <!--LiveInternet counter-->
        <script type="text/javascript">
  ...
  <xsl:template match="doc[contains(key('protocol', 'host'), 'neftegaz')]" mode="counters">
    <div class="margin">
      <div class="layout__padding">
        <!--LiveInternet counter-->
        <script type="text/javascript">
  ...
  <xsl:template match="doc[contains(key('protocol', 'host'), 'engineer')]" mode="counters">
    <!-- Yandex.Metrika counter -->
    <div style="display:none;"><script type="text/javascript">
        (function(w, c) {
          (w[c] = w[c] || []).push(function() {
              try {
                  w.yaCounter4120441 = new Ya.Metrika(4120441);
                   yaCounter4120441.clickmap(true);
                   yaCounter4120441.trackLinks(true);
    ...
    <noscript><div style="position:absolute"><img src="//mc.yandex.ru/watch/4120441" alt=""/></div></noscript>
    <!-- /Yandex.Metrika counter -->
    <div class="margin">
      <div class="layout__padding">
        <!--LiveInternet counter-->
