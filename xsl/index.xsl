...
<xsl:output
  ...
  <xsl:template match="doc[contains(key('protocol', 'host'), 'engineer')]" mode="seo-text">
    <p>
      В мире сейчас насчитывается более 70 000 профессий, но вы уже твёрдо выбрали своё направление и это направление - работа инженером! 
    </p>
    <p>
      Сейчас всё больше и больше молодых людей и девушек выбирают гуманитарное образования, и в связи с этим идёт сильная нехватка кадров в индустриальной сфере. И именно это позволяет тем людям, для кого работа инженером является любимым делом, стремительно подниматься по карьерной лестнице, иметь хороший заработок и быть уверенным в своём будущем! 
    </p>
    <p>
      Естественно, для успешной карьеры требуется сначала найти хорошие вакансии инженера, но отобрать их не так уж и просто на просторах интернета. Для облегчения поиска и создан наш портал! Тут собраны самые лучшие предложения работ для инженера любой специальности. Всё доступно и просто, больше не надо сидеть на куче сайтов и судорожно перелистывать десятки вкладок натыкаясь на одинаковые вакансии инженера. У нас проверенные и уникальные предложения от различных компаний в любой сфере деятельности, вы всегда найдёте то, что вас интересует!
    </p>
    <p>
      Поиск по вакансиям конечно эффективен, но если вы хотите найти работу быстро и качественно, то одними запросами «вакансии инженер Москва» или «работа инженер» вы не должны ограничиваться! Создайте своё резюме, сделайте его ярким с помощью наших удобных сервисов и ваш будущий работодатель не сможет пройти мимо!
    </p>
    <p>
      Цените себя и своё время! Engineer.hh.ru  – мы предлагаем лучшее будущее! 
    </p>
  </xsl:template>
