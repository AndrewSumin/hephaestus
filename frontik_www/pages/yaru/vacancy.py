...
class Page(frontik.handler.PageHandler):
    ...
    def post_page(self):
        ...
        data = '<?xml version="1.0" encoding="utf-8"?><entry xmlns:y="yandex:data" xmlns="http://www.w3.org/2005/Atom"><title>{title}</title><y:access>public</y:access><category scheme="urn:ya.ru:posttypes" term="text"/><content>{text}</content></entry>'.format(
